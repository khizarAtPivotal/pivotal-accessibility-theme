...
<div id="comments" class="comments-area">
		...
		<h2 class="comments-title">
			<?php
				printf(
					...
					esc_html( _n( '%d Comment.', '%d Comments.', get_comments_number(), 'pivotalaccessibility' ) ),
	...
	?>
		...
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'pivotalaccessibility' ); ?></p>
	<?php
	endif;
